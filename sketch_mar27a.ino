...
//---------------------------------------------------------------------
const char * ssid = "PARKS  APM-A_2.4G";
const char * password = "PArKsapM4";
String GOOGLE_SCRIPT_ID = "AKfycbwGBoNwirLELJ0IBEqXDtggPDmXhsa_ajWPA5UySk58UmVJ_Tr8JX_su7It9ePy1wd4bQ";
//---------------------------------------------------------------------
